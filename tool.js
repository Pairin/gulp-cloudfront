    ...
    var updateDefaultRootObject = function (defaultRootObject) {
        ...
        cloudfront.getDistribution({ Id: options.distributionId }, function(err, data) {
            ...
            if (err) {
                ...
                // Update the responspage on the 404 CustomErrorResponse, this is needed for
                // html5-mode / safari
                if (data.DistributionConfig.CustomErrorResponses.Items[0] !== 'undefined' && data.DistributionConfig.CustomErrorResponses.Items[0].ErrorCode === 404) {
